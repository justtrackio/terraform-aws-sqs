...
| <a name="input_alarm"></a> [alarm](#input\_alarm) | n/a | <pre>object({<br>    datapoints_to_alarm = optional(number, 3)<br>    description         = optional(string, null)<br>    evaluation_periods  = optional(number, 3)<br>    backlog_minutes     = optional(number, 3)<br>    period              = optional(number, 60)<br>    threshold           = optional(number, 0)<br>  })</pre> | `{}` | no |
...
| <a name="input_dlq_max_receive_count"></a> [dlq\_max\_receive\_count](#input\_dlq\_max\_receive\_count) | n/a | `number` | `5` | no |
...
| <a name="input_subscription"></a> [subscription](#input\_subscription) | n/a | <pre>map(object({<br>    topic_name    = string<br>    filter_policy = optional(string)<br>  }))</pre> | `null` | no |
| <a name="input_subscription_aws_account_id"></a> [subscription\_aws\_account\_id](#input\_subscription\_aws\_account\_id) | n/a | `string` | n/a | yes |
